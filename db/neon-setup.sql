-- LexTrack — esquema RAG para Neon (PostgreSQL + pgvector).
-- Ejecuta este archivo completo en: Neon → SQL Editor → Run.
-- Requiere dimensión de embeddings 1024 (p. ej. voyage-law-2).
